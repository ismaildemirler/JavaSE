...
public class _Abstraction {
	 ...
	 * Abstract class vs Interface 
	   ...
	   - Inheritance vs Abstraction: A Java interface can be implemented using the keyword â€œimplementsâ€? 
	     and an abstract class can be extended using the keyword â€œextendsâ€?. 
